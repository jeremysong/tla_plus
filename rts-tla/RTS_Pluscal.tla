...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "31dbc12e" /\ chksum(tla) = "3ec2ede1")
...
Init == (* Global variables *)
        ...
        (* Process Publisher *)
        /\ v = [self \in PublishProcess |-> defaultInitValue]
        /\ pc = [self \in ProcSet |-> CASE self \in OtsHost -> "READ"
                                        [] self \in PublishProcess -> "INIT"]
...
Publisher(self) == INIT(self) \/ WRITE(self) \/ STATUS(self)
